...
public class NewTest {
  ...
  public void test1() throws InterruptedException {
	  ...
	  Assert.assertEquals(landing.getPageTitle(),"Please enter your Representative Access Code, to access site.");
		landing.accesscode("NENY0000");
		landing.submitAgentCode();
		
		
		if(landing.verifyAgentTitle().equalsIgnoreCase("Please confirm that your are accesing the site with the correct representative access code.")) {
			System.out.println("PASSED");
		}else {
			System.out.println("FAILED");
		}
		
	//	Assert.assertEquals(landing.verifyAgentTitle(),"Please confirm that your are accessing the site with the correct representative access code.");
